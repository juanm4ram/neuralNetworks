...
window.PAPERS = [
  {
    ...
    en: {
      ...
      descripcion:
        'The test loss of an LLM falls predictably as compute, data and size are scaled, with diminishing returns. This is the regression data used on pages 1 and 2.',
      paper: 'Scaling Laws for Neural Language Models',
      fuente: 'Kaplan et al., OpenAI — 2020',
    },
  },
  {
    ...
    en: {
      ...
      descripcion:
        'Reasoning step by step during inference (Test-Time Compute) shows a direct benefit from thinking time. It is the second variable on page 3.',
      paper: 'Chain-of-Thought Prompting Elicits Reasoning in LLMs',
      fuente: 'Wei et al., Google — 2022',
    },
  },
  {
    ...
    en: {
      ...
      descripcion:
        'On parallelisable tasks, coordinating many agents boosts success (+80.8%); on sequential tasks it degrades it (−39% to −70%). It is the XOR pattern of page 6.',
      paper: 'Towards a Science of Scaling Agent Systems',
      fuente: 'Google DeepMind + MIT — 2025',
    },
  },
  {
    ...
    en: {
      ...
      descripcion:
        'Evaluates LLM agents on Minecraft crafting, where each recipe depends on the previous one: the sequential-task example on page 6.',
      paper: 'Plancraft: an evaluation dataset for planning with LLM agents',
  ...
  },
  {
    ...
    en: {
      ...
      descripcion:
        'The paper that ended the AI winter: a multi-layer network can adjust all its parameters by propagating the error backwards. It is the algorithm of page 8.',
      paper: 'Learning representations by back-propagating errors',
